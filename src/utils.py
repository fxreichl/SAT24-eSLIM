...
class Configuration :
  ...
  def __init__(self) :
    ...
    self.abc_cmds_aig = "&get -n; &deepsyn -T 300; &put"
  ...
  def validateConfig(self) :
    ...
    if self.synthesis_approach in {Configuration.SynthesisationMode.qbf, Configuration.SynthesisationMode.exact} :
      assert self.qbf_solver in {Configuration.QBFSolver.miniQU, Configuration.QBFSolver.QFun, Configuration.QBFSolver.quabs}, "Invalid QBF solver selected"
