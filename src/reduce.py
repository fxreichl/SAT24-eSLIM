...
if __name__ == "__main__" :
  ...
  # misc
  parser.add_argument('--qbf-solver', choices=['qfun', 'miniqu', 'quabs'], help='The solver to use')
  ...
  parser.add_argument("--fixed-size", action='store_true', help='Do not modify the subcircuit size')
  ...
  parser.add_argument('--expansion', choices=["bfs", "rbfs", "inmin", "outmin", "so"], help='The expansion strategy to use', default='inmin')
